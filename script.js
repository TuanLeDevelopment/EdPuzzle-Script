...
function openPopup(assignment) {
  ...
  <hr>
  <p style="font-size: 12px">Made by: <a target="_blank" href="">Twane</a> on Github | Website: <a target="_blank" href="">edpuzzle.hs.vc</a> | Source code: <a target="_blank" href="</a></p>
  ...
  <p style="font-size: 12px">Available now from our <a target="_blank" href="">Discord server</a>: <i> An open beta of a completely overhauled GUI, with proper mobile support, ChatGPT integration for open-ended questions, and more. </i></p>`;
